...
enum instruction_operation_t {
    ...
    /// HIVE
    INSTRUCTION_OPERATION_HIVE_LOCK,     //12
    INSTRUCTION_OPERATION_HIVE_UNLOCK,   //13

    INSTRUCTION_OPERATION_HIVE_LOAD,     //14
    INSTRUCTION_OPERATION_HIVE_STORE,    //15

    INSTRUCTION_OPERATION_HIVE_INT_ALU,  //16
    INSTRUCTION_OPERATION_HIVE_INT_MUL,  //17
    INSTRUCTION_OPERATION_HIVE_INT_DIV,  //18

    INSTRUCTION_OPERATION_HIVE_FP_ALU,   //19
    INSTRUCTION_OPERATION_HIVE_FP_MUL,   //20
    INSTRUCTION_OPERATION_HIVE_FP_DIV    //21
};
