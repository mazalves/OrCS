...
branch_predictor_t::branch_predictor_t(){
	...
	set_BTB_ENTRIES (cfg_root[0]["PROCESSOR"][0]["BTB_ENTRIES"]);
    set_BTB_WAYS (cfg_root[0]["PROCESSOR"][0]["BTB_WAYS"]);
    set_BTB_MISS_PENALITY (cfg_root[0]["PROCESSOR"][0]["BTB_MISS_PENALITY"]);
    set_MISSPREDICTION_PENALITY (cfg_root[0]["PROCESSOR"][0]["MISSPREDICTION_PENALITY"]);
	if (!strcmp (cfg_root[0]["PROCESSOR"][0]["BRANCH_PREDICTION_METHOD"], "PIECEWISE")) this->BRANCH_PREDICTION_METHOD = BRANCH_PREDICTION_METHOD_PIECEWISE;
	else if (!strcmp (cfg_root[0]["PROCESSOR"][0]["BRANCH_PREDICTION_METHOD"], "TWO_BIT")) this->BRANCH_PREDICTION_METHOD = BRANCH_PREDICTION_METHOD_TWO_BIT;
}
branch_predictor_t::~branch_predictor_t(){
